...
class ListTopicsLessonComponent extends StatefulWidget {
  const ListTopicsLessonComponent({super.key, required this.course, required this.index});
...
class _ListTopicsLessonComponentState extends State<ListTopicsLessonComponent> {
  ...
  Widget _buildPDFView() {
    debugPrint('NAMEFILE: ${widget.course.topics?[selectedTopicIndex].nameFile}' );
    return Container(
      decoration: BoxDecoration(
